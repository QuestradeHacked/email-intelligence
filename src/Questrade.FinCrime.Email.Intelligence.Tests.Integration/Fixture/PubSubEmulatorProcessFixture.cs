...
using Questrade.FinCrime.Email.Intelligence.Tests.Integration.Config;

namespace Questrade.FinCrime.Email.Intelligence.Tests.Integration.Fixture;
...
public class PubSubEmulatorProcessFixture
{
    ...
    public EmailIntelligenceSubscriberConfiguration CreateDefaultSubscriberConfig(string subscriptionId)
    {
        return new EmailIntelligenceSubscriberConfiguration
        {
